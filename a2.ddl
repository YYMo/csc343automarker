...
DROP TABLE IF EXISTS Query1ans CASCADE;
DROP TABLE IF EXISTS Query2ans CASCADE;
DROP TABLE IF EXISTS Query3ans CASCADE;
DROP TABLE IF EXISTS Query4ans CASCADE;
DROP TABLE IF EXISTS Query5ans CASCADE;
DROP TABLE IF EXISTS Query6ans CASCADE;
DROP TABLE IF EXISTS Query7ans CASCADE;
DROP TABLE IF EXISTS Query8ans CASCADE;
DROP TABLE IF EXISTS Query9ans CASCADE;
DROP TABLE IF EXISTS Query10ans CASCADE;
...
CREATE TABLE Query4ans(
    cname   VARCHAR(20),
    oname   VARCHAR(20)
);

CREATE TABLE Query5ans(
    cid     INTEGER,
    cname   VARCHAR(20),
    avghdi  REAL
);

CREATE TABLE Query6ans(
    cid     INTEGER,
    cname   VARCHAR(20)
);

CREATE TABLE Query7ans(
    rid         INTEGER,
    rname       VARCHAR(20),
    followers   INTEGER
);

CREATE TABLE Query8ans(
    c1name  VARCHAR(20),
    c2name  VARCHAR(20),
    lname   VARCHAR(20)
);

CREATE TABLE Query9ans(
    cname       VARCHAR(20),
    totalspan   INTEGER
);

CREATE TABLE Query10ans(
    cname           VARCHAR(20),
    borderslength   INTEGER
);